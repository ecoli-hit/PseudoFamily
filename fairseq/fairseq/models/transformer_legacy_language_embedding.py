...
from fairseq.models.transformer_base_embedding import (
    TransformerModelLanaguageEembedding
)


@register_model("transformer_language_embedding")
class TransformerModel_embedding(TransformerModelLanaguageEembedding):
    """
    ...
    def build_model(cls, args, task):
        ...
        transformer_language_embedding(args)
...
@register_model_architecture("transformer_language_embedding", "transformer_language_embedding")
def transformer_language_embedding(args):
