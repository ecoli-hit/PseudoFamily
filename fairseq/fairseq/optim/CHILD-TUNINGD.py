...
@register_optimizer("CHILD_TUNINGD", dataclass=FairseqAdamConfig)
class FairseqAdam(FairseqOptimizer):
    ...
    def __init__(self, cfg: FairseqAdamConfig, params):
        ...
        if getattr(cfg, "tpu", False):
            ...
            self._optimizer = CHILD_TUNINGD(params, **self.optimizer_config)
        elif use_fused_adam:
...
class CHILD_TUNINGD(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        super(CHILD_TUNINGD, self).__init__(params, defaults)
        self.fisher_information = None
        self.gradient_mask = None
        self.model = None
        self.done = False
        
    def set_fisher_mask(self, gradient_mask,model):
        import copy
        self.gradient_mask = copy.deepcopy(gradient_mask)
        self.model = model
        self.done = True
