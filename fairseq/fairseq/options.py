...
def get_training_parser(default_task="translation"):
    ...
    add_ema_args(parser)
    add_fisher_args(parser)
    return parser

def add_fisher_args(parser):
    group = parser.add_argument_group("fisher")
    # fmt: off
    group.add_argument("--generate_mask",default=False,type=str)
    group.add_argument("--load_mask_file",type=str)
    group.add_argument("--dumpfisher", default=False, type=str,
                       help="dump fisher information for one epoch")
    group.add_argument("--dumpfisherfile", default=None, type=str,
                       help="dump fisher information to file")
    
    group.add_argument("--resample",default=None,type=str)
    group.add_argument("--centernum",default=None,type=int)
    
    group.add_argument("--fishermask",default=None,type=str)
