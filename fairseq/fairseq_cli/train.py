...
def train(
    ...
    if cfg.model.dumpfisher == "true":
        trainer.dumpfisher()
        return valid_losses, True

    if cfg.model.fishermask == "true" and not trainer.optimizer.optimizer.done:
        trainer.calcu_mask()
    
    ## change sample ratios 
    if cfg.model.resample == "true":
        trainer.adapt_sample_ratio(epoch_itr.epoch,cfg.model.centernum)
