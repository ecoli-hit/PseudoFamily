...
def shuffle(res,dev_len,seed=1):
    ''' dev_len if [0,1] sample as ratio else sample as lines'''
...
if __name__ == '__main__':
    ...
    write_file(res=[data[0]+"\n" for data in dev_set],file=os.path.join(out_folder+'/',f"valid.{src_lang}"))
    write_file(res=[data[1]+"\n" for data in dev_set],file=os.path.join(out_folder+'/',f"valid.{tgt_lang}"))